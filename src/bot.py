...
def main():
    ...
    application.add_handler(CommandHandler("lane_settings", flashcard_handlers.lane_settings))
    application.add_handler(CommandHandler("lane_deck", flashcard_handlers.lane_deck))
    application.add_handler(CommandHandler("lane_tags", flashcard_handlers.lane_tags))
